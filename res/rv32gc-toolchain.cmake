...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -D__riscv__ -Oz -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -fno-builtin-bcmp")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -D__riscv__ -Oz -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -fno-builtin-bcmp")
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -D__riscv__ -Oz -march=${RISCV_ARCH} -mabi=${RISCV_ABI} ")
set(CMAKE_EXE_LINKER_FLAGS "-Oz -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -nostartfiles")
set(COMPILE_FLAGS "${COMPILE_FLAGS} -Oz -c")
